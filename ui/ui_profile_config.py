...
class Ui_ProfileConfig(object):
    def setupUi(self, ProfileConfigDialog):
        ...
        self.fieldListLabel = QLabel(self.mainFrame)
        self.fieldListLabel.setObjectName(u"fieldListLabel")

        self.gridLayout_3.addWidget(self.fieldListLabel, 5, 1, 1, 2)
    ...
    def retranslateUi(self, ProfileConfigDialog):
        ...
        self.sandboxCidLabel.setText(QCoreApplication.translate("ProfileConfigDialog", u"Sandbox Consumer Key:", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.prodCidLabel.setText(QCoreApplication.translate("ProfileConfigDialog", u"Production Consumer Key:", None))
        ...
        self.fieldListLabel.setText(QCoreApplication.translate("ProfileConfigDialog", u"-none-", None))
    # retranslateUi
